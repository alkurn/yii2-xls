 ...
 * 
 * Array([0] => Array([name] => Anam, [email] => ganesh.alkurn@gmail.com, [framework interest] => Yii2), 
 * [1] => Array([name] => Example, [email] => example@alkurn.info, [framework interest] => Yii2));
 * 
 * // data with multiple worksheet
 * 
 * Array([Sheet1] => Array([0] => Array([name] => Anam, [email] => ganesh.alkurn@gmail.com, [framework interest] => Yii2), 
 * [1] => Array([name] => Example, [email] => example@alkurn.info, [framework interest] => Yii2)),
 * [Sheet2] => Array([0] => Array([name] => Anam, [email] => ganesh.alkurn@gmail.com, [framework interest] => Yii2), 
 * [1] => Array([name] => Example, [email] => example@alkurn.info, [framework interest] => Yii2)));
 * 
 * // data with multiple file and specified sheet or only one worksheet
 * 
 * Array([file1] => Array([0] => Array([name] => Anam, [email] => ganesh.alkurn@gmail.com, [framework interest] => Yii2), 
 * [1] => Array([name] => Example, [email] => example@alkurn.info, [framework interest] => Yii2)),
 * [file2] => Array([0] => Array([name] => Anam, [email] => ganesh.alkurn@gmail.com, [framework interest] => Yii2), 
 * [1] => Array([name] => Example, [email] => example@alkurn.info, [framework interest] => Yii2)));
 * 
 * // data with multiple file and multiple worksheet
 * 
 * Array([file1] => Array([Sheet1] => Array([0] => Array([name] => Anam, [email] => ganesh.alkurn@gmail.com, [framework interest] => Yii2), 
 * [1] => Array([name] => Example, [email] => example@alkurn.info, [framework interest] => Yii2)),
 * [Sheet2] => Array([0] => Array([name] => Anam, [email] => ganesh.alkurn@gmail.com, [framework interest] => Yii2), 
 * [1] => Array([name] => Example, [email] => example@alkurn.info, [framework interest] => Yii2))),
 * [file2] => Array([Sheet1] => Array([0] => Array([name] => Anam, [email] => ganesh.alkurn@gmail.com, [framework interest] => Yii2), 
 * [1] => Array([name] => Example, [email] => example@alkurn.info, [framework interest] => Yii2)),
 * [Sheet2] => Array([0] => Array([name] => Anam, [email] => ganesh.alkurn@gmail.com, [framework interest] => Yii2), 
 * [1] => Array([name] => Example, [email] => example@alkurn.info, [framework interest] => Yii2))));
 * 
...
class Excel extends \yii\base\Widget
{
	...
	public function readFile($fileName)
	{
		...
		$objectxls = $objectreader->load($fileName);
		
		$sheetCount = $objectxls->getSheetCount();
		
		$sheetDatas = [];
		
		if ($sheetCount > 1) {
			foreach ($objectxls->getSheetNames() as $sheetIndex => $sheetName) {
				if (isset($this->getOnlySheet) && $this->getOnlySheet != null) {
					if(!$objectxls->getSheetByName($this->getOnlySheet)) {
						return $sheetDatas;
					}
					$objectxls->setActiveSheetIndexByName($this->getOnlySheet);
					$indexed = $this->getOnlySheet;
					$sheetDatas[$indexed] = $objectxls->getActiveSheet()->toArray(null, true, true, true);
					...
					$objectxls->setActiveSheetIndexByName($sheetName);
			...
			$sheetDatas = $objectxls->getActiveSheet()->toArray(null, true, true, true);
			if ($this->setFirstRecordAsKeys) {
    ...
    public function csvExport($dataProvider, $config = [])
    {
        if(\Yii::$app->request->get('csv') == 'download'){
            $xls = new self();
            $models = [];
	 ...
	 * ~~~
	 * 
	 * $data = \alkurn\xls\Excel::import($fileName, ['setFirstRecordAsKeys' => true]);
	 * 
	 * ~~~
	 * 
